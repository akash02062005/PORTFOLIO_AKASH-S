...
export default function Hero() {
  return (
    <section id="top" className="section !pb-8 !pt-24 md:!pt-28">
      ...
      <div className="grid grid-cols-[34%,1fr] items-center gap-5 sm:grid-cols-[30%,1fr] sm:gap-8 lg:grid-cols-[1fr,300px] lg:gap-16">
        <div className="relative lg:order-2">
          ...
          <img
            src={about.photo}
            alt={profile.name}
            className="aspect-[4/5] w-full rounded-xl border border-line object-cover object-top grayscale transition-all duration-500 hover:grayscale-0 sm:rounded-2xl"
          />
        </div>
        ...
        <div className="lg:order-1">
          ...
          <span className="mt-3 inline-flex items-center gap-1.5 rounded-full border border-ink bg-ink px-2.5 py-1 text-[10px] font-semibold text-paper sm:text-xs lg:hidden">
      ...
      {/* Row 2: full-width below the photo on mobile only */}
      <div className="mt-5 lg:hidden">
        ...
        <p className="mt-4 leading-relaxed text-muted">{profile.tagline}</p>
        <div className="mt-3 flex flex-wrap items-center gap-x-4 gap-y-1.5 text-xs text-faint sm:text-sm">
          <span className="inline-flex items-center gap-1.5">
        ...
        <div className="mt-5 flex items-center gap-6 text-muted">
          <a href={profile.socials.github} target="_blank" rel="noreferrer" aria-label="GitHub" className="transition-colors hover:text-ink">
            <Github size={19} />
          </a>
          <a href={profile.socials.linkedin} target="_blank" rel="noreferrer" aria-label="LinkedIn" className="transition-colors hover:text-ink">
